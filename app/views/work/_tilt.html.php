...
<?php 
$this->title('Tilt');
$this->set(array('main_img' => $img_base . '/work/tilt/tilt-0.jpg'));
	...
	<div class="content-inner">
		...
		<div class="grid">
			...
			<div class="full-width">
				<figure>
					<img src="<?= $img_base ?>/work/tilt/tilt-1.jpg" alt="Concepting and wireframing during an initial discovery phase." />
				</figure>
			</div>
			
			<div class="full-width">
				<figure>
					<img src="<?= $img_base ?>/work/tilt/tilt-4.jpg" alt="A collection of projects displayed on the TILT website" />
				</figure>
			</div>
			
			<div class="full-width">
				<figure>
					<img src="<?= $img_base ?>/work/tilt/tilt-8.jpg" alt="The TILT website home page viewed on iPad and iPhone." />
				</figure>
			</div>
			
			<div class="full-width">
				<figure>
					<img src="<?= $img_base ?>/work/tilt/tilt-9.jpg" alt="Displaying imagery using a custom designed lightbox." />
				</figure>
			</div>
			
			<div class="full-width">
				<figure>
					<img src="<?= $img_base ?>/work/tilt/tilt-10.jpg" alt="Displaying the product details on the TILT website." />
				</figure>
			</div>
			
			<div class="full-width">
				<figure>
					<img src="<?= $img_base ?>/work/tilt/tilt-3.jpg" alt="Various pages of teh TILT website as displayed on an iPhone." />
				</figure>
			</div>
			
			<div class="full-width">
				<figure>
					<img src="<?= $img_base ?>/work/tilt/tilt-7.jpg" alt="TILT’s Studio page, showing a collection of information about the studio and time-sensitive content from the blog, Twitter and Facebook." />
				</figure>
			</div>
